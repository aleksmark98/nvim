return {
   ...
   config = function()
      ...
      vim.keymap.set('n', '<M-A-h>', require('smart-splits').resize_left)
      vim.keymap.set('n', '<M-A-j>', require('smart-splits').resize_down)
      vim.keymap.set('n', '<M-A-k>', require('smart-splits').resize_up)
      vim.keymap.set('n', '<M-A-l>', require('smart-splits').resize_right)
